...
the ypi folder is the express server for the root page. I did not connect it to the root page as I was not sure how
it would change the process of reactifying eveything. (To connect it to the rootPage go to app.js in ypi)
